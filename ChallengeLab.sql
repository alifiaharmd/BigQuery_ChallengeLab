...
--The query needs to list the output in the field count_of_states. Hint: Don't include NULL values.
...
--Write a query to return the ratio for the month of April 2020 and 
--containing the following fields in the output: total_confirmed_cases, total_deaths, case_fatality_ratio.
...
--===========================================
--The following query is written to identify the number of days in India between 21 Feb 2020 and 15 March 2020 
--when there were zero increases in the number of confirmed cases. 
...
--======================
--Using the previous query as a template, write a query to find out the dates on which the confirmed cases increased by 
--more than 10% compared to the previous day (indicating doubling rate of ~ 7 days) in the US between the dates March 22, 2020 and April 20, 2020. 
...
--======================
--Build a query to list the recovery rates of countries arranged in descending order (limit to 10) on the date May 10, 2020. 
...
--==================================
--Create query for datastudio report
--==================================
-- Get this from the United States data:
